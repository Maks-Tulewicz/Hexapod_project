...
namespace hex_controller
{
    ...
    // Definicje kodów klawiszy - przenosimy do nagłówka, aby były dostępne globalnie
    ...
    constexpr char KEYCODE_M = 0x6D;
    constexpr char KEYCODE_COMMA = 0x2C;
    constexpr char KEYCODE_PERIOD = 0x2E;
